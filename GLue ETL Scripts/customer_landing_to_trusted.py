...
Customer_landing_node1758785729646 = glueContext.create_dynamic_frame.from_options(format_options={"multiLine": "false"}, connection_type="s3", format="json", connection_options={"paths": ["s3://stedi-datalakehouse/customer/landing/"], "recurse": True}, transformation_ctx="Customer_landing_node1758785729646")
...
'''
SQLQuery_node1758786706862 = sparkSqlQuery(glueContext, query = SqlQuery3613, mapping = {"myDataSource":Customer_landing_node1758785729646}, transformation_ctx = "SQLQuery_node1758786706862")
