...
customer_trusted_node1758776101057 = glueContext.create_dynamic_frame.from_catalog(database="stedi_datalakehouse", table_name="customer_trusted", transformation_ctx="customer_trusted_node1758776101057")

# Script generated for node acceleometer_trusted
acceleometer_trusted_node1758776066833 = glueContext.create_dynamic_frame.from_catalog(database="stedi_datalakehouse", table_name="accelerometer_trusted", transformation_ctx="acceleometer_trusted_node1758776066833")
...
a  on c.email = a.user
'''
SQLQuery_node1758776135790 = sparkSqlQuery(glueContext, query = SqlQuery4001, mapping = {"c":customer_trusted_node1758776101057, "myDataSource":acceleometer_trusted_node1758776066833}, transformation_ctx = "SQLQuery_node1758776135790")
